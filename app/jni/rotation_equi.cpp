...
extern "C"
{
    ...
    Java_com_theta360_tracking_MainActivity_version(
            JNIEnv *env,
            jobject) {
    ...
    JNICALL Java_com_theta360_tracking_MainActivity_rotateEqui
            (
                    JNIEnv *env,
                    jobject obj,
    ...
    JNIEXPORT jbyteArray
    JNICALL Java_com_theta360_tracking_MainActivity_rotateEqui2
            (
                    JNIEnv *env,
                    jobject obj,
